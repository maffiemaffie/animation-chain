namespace AnimChain
{
    public class AnimChainApp
    {
        ...
        /// <summary>
        /// Instance variable represents the <see cref="AnimChain"/> that will be used to render am animation.
        /// </summary>
        ...
        public AnimChainApp(AnimChain chain, Configs configs)
        {
            this.chain = chain;
        ...
        private class Configs
        {
            ...
            public Configs((int Width, int Height) resolution, int frameDelay, FileFormat format)
            {
            ...
            /// <param name="format">The file format of the exported animation.</param>
            public Configs((int Width, int Height) resolution, double frameRate, FileFormat format)
            {
                Resolution = resolution;
                FrameRate = frameRate;
                Format = format;
